<%@ Page Title="" Language="C#" MasterPageFile="~/STGSite.Master" AutoEventWireup="true" CodeBehind="STGServices.aspx.cs" Inherits="STGWifi.STGServices" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <div class="featurette">
        <img class="featurette-image pull-right" src="bootstrap-master/bootstrap-master/docs/assets/img/examples/browser-icon-safari.png"/>
    ...
    <hr class="featurette-divider"/>
       <div class="featurette">
        <img class="featurette-image pull-left" src="bootstrap-master/bootstrap-master/docs/assets/img/examples/browser-icon-firefox.png"/>
